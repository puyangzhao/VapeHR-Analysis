...
# filtered_uids = ['user1', 'user2', ...]

# Process all users to compute matrix profiles
all_matrix_profiles, hr_nosleep_df = process_all_users(filtered_uids, eventdata)

# Create annotation vectors for all users
annotation_vectors = create_annotation_vectors(eventdata, all_matrix_profiles, filtered_uids)
