...
def create_annotation_vectors(eventdata, all_matrix_profiles, filtered_uids):
    ...
    eventdata['time_diff'] = eventdata.groupby('UID')['isoDate'].diff().fillna(pd.Timedelta(seconds=0))
    ...
    for user_id in filtered_uids:
        ...
        user_events = eventdata[eventdata['UID'] == user_id]
